...
def analyseYolo(chemin_vid, vid_deja_faite, progression_callback=None):
    ...
    camera_mouvement = CameraMouvement(video_images[0])
    camera_movement_par_frame = camera_mouvement.get_camera_mouvement(video_images)
    camera_mouvement.ajouter_position_ajustee_aux_tracks(tracks, camera_movement_par_frame)
    # Ajouter la transformation de position
    transformation = Position_transforme()
    transformation.ajouter_position_transforme_au_tracks(tracks)
    ...
    video_sortie_images = camera_mouvement.dessiner_mouvement_camera(video_sortie_images, camera_movement_par_frame)
